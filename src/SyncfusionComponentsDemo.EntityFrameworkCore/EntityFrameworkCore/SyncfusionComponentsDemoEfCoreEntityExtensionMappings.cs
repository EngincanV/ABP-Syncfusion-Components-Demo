...
{
    public static class SyncfusionComponentsDemoEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE SyncfusionComponentsDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
